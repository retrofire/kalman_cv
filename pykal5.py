...
print "Main 286 - Run KF - measurements", measurements
...
print "Main 289 - Run KF - filtered_measurements", filtered_measurements
...
### OFFSET Results ##
print "Main 311 - plot_first_dim - measurements[:3] "
plot_first_dim(
    measurements[:3],
...
print "Main 319 - plot_first_dim - corrected_positions "
plot_first_dim(
    corrected_positions,
...
print "Main 327 - plot_first_dim - filtered_measurements "
plot_first_dim(
...
print "Main 332 - length corrected_positions = ", len(corrected_positions), " length measurements = ", len(measurements)
